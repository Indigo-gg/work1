DATASET_PATHS = [
    ...
    # ),
    dict(
        real_path='./data/test_data/0_real',
        fake_path='./data/test_data/1_fake',
        data_mode='wang2020',
        key='custom_dataset'
    ),
       dict(
        real_path='./data/test_out_data/0_real',
        fake_path='./data/test_out_data/1_fake',
        data_mode='wang2020',
        key='custom_out_dataset'
    )
